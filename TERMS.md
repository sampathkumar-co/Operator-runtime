...
Users choose which devices and project roots are authorized. Local policy, OAuth scopes, one-time approval controls and the emergency stop may block a requested action even when ChatGPT asks to perform it.

Users must protect their account, paired devices and recovery credentials. Suspected compromise should be handled by revoking affected device/account access and contacting support through the published support page.

## Service availability and changes

The service may be interrupted for maintenance, security response, provider outages or changes required by OpenAI or other platform policies. Features and public-plugin tools may change through reviewed releases.

## Data and privacy

The production Privacy Policy describes categories of data processed, purposes, retention and deletion controls. The public plugin is designed not to process authentication secrets or other restricted-data categories excluded by its public policy boundary.
