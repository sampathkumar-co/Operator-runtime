...
| G29 Public Truthfulness | BLOCKED | The Mecord Connect integrated successor has source-controlled branding/legal notices, but production still serves pre-rebrand OCC-3M pages and the exact legal publisher identity/software license remain unresolved. FG-013, FG-017 and FG-021 must pass before the public listing/legal/package claims are final. |
...
| G35 Submission Readiness | BLOCKED | Mecord Connect branding is green in integrated PR #27, but final live branding deployment, exact publisher legal-identity reconciliation/verification, reviewer login/pairing, npm release, domain challenge if issued, Scan Tools, authenticated E2E and the required reviewer-accessible demo recording URL are still incomplete. |
