...
| FG-006 | P2-release | BLOCKED-HUMAN | No dedicated reviewer account/fixture has been certified for OpenAI review. | Follow `OPERATOR_REMAINING_HUMAN_GATES.md`: use a reviewer-only one-factor OIDC policy while preserving two-factor as the default for normal users; provision disposable credentials outside Git and a paired non-sensitive fixture. |
