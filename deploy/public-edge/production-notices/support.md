...
The same address accepts device-reset, account-erasure, privacy, access, correction, and deletion requests. Identity verification may be required before a request affecting an account or paired device is completed.
